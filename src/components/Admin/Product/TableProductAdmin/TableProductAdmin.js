      ...
      <Table.Body>
        {map(products, (product, index) => (
          <Table.Row key={index}>
            ...
            <Table.Cell>{product && product.title}</Table.Cell>
            <Table.Cell className="price-cell">{product && product.price ? `$ ${product.price} ` : ''}</Table.Cell>
            <Table.Cell>{product && product.category_data && product.category_data.title}</Table.Cell>
            <Table.Cell className="status">
              {product && product.active ? <Icon name="check" /> : <Icon name="close" />}
            </Table.Cell>
